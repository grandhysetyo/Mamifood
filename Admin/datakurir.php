                                    ...
                                    <div id="example23_wrapper" class="dataTables_wrapper">
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="example23" rowspan="1" colspan="1" aria-label="Nama Kurir: activate to sort column ascending" style="width: 150.4px;">Nama Kurir</th>
                                                <th class="sorting" tabindex="0" aria-controls="example23" rowspan="1" colspan="1" aria-label="NoHp. Kurir: activate to sort column ascending" style="width: 137.4px;">NoHp. Kurir</th>
                                                <th class="sorting" tabindex="0" aria-controls="example23" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 65.4px;">Status</th>
                                                <th class="sorting" tabindex="0" aria-controls="example23" rowspan="1" colspan="1" aria-label="Alamat Kurir: activate to sort column ascending" style="width: 128.4px;">Action</th>
                                            </tr>
                                        </thead>
                                        <!-- <tfoot>
                                        ...
                                        <?php 
                                            ...
                                            $query = $conn->query("SELECT * FROM tb_kurir");
