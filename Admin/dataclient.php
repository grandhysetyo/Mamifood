                                    ...
                                    <div id="example23_wrapper" class="dataTables_wrapper">
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="example23" rowspan="1" colspan="1" aria-label="Nama Client: activate to sort column ascending" style="width: 150.4px;">Nama Client</th>
                                                <th class="sorting" tabindex="0" aria-controls="example23" rowspan="1" colspan="1" aria-label="NoHp. Client: activate to sort column ascending" style="width: 137.4px;">NoHp. Client</th>
                                                <th class="sorting" tabindex="0" aria-controls="example23" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 65.4px;">Alamat Client</th>
                                                <th class="sorting" tabindex="0" aria-controls="example23" rowspan="1" colspan="1" aria-label="NoHp. Client: activate to sort column ascending" style="width: 137.4px;">Status</th>
                                                <th class="sorting" tabindex="0" aria-controls="example23" rowspan="1" colspan="1" aria-label="Alamat Client: activate to sort column ascending" style="width: 128.4px;">Action</th>
                                            </tr>
                                        </thead>
                                        <!-- <tfoot>
                                        ...
                                        <?php 
                                            ...
                                            $query = $conn->query("SELECT * FROM tb_client");
                                            ...
                                            ?>
                                              <tr>
                                                ...
                                                <td><?=  $data['noHpClient']; ?></td>
                                                <td><?=  $data['alamatClient']; ?></td>
                                                <td><?=  $data['status']; ?></td>
                                                <td>
