                                    ...
                                    <div id="example23_wrapper" class="dataTables_wrapper">
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="example23" rowspan="1" colspan="1" aria-label="Nama Makanan: activate to sort column ascending" style="width: 150.4px;">Nama Makanan</th>
                                                <th class="sorting" tabindex="0" aria-controls="example23" rowspan="1" colspan="1" aria-label="NoHp. Makanan: activate to sort column ascending" style="width: 137.4px;">Harga Makanan</th>
                                        ...
                                        <?php 
                                            ...
                                            $query = $conn->query("SELECT * FROM tb_makanan");
